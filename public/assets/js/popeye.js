                        ...
                        PopeyeModal = (function() {
                            function PopeyeModal(options) {
                                ...
                                if (
                                    ...
                                    throw new Error(
                                        "template or templateUrl must be provided"
                                    );
                                }
                                this.options = angular.extend(
                                    angular.copy(PopeyeProvider.defaults),
                                    options
                                );
                                    ...
                                    .then(
                                        (function(_this) {
                                            return function(resolved) {
                                                _this.scope =
                                                    _this.options.scope != null
                                                        ? _this.options.scope
                                                        : $rootScope.$new();
                                                _this.scope.$close = function() {
                                                    return _this.close.apply(
                                                        _this,
                                                        arguments
                                                    );
                                                };
                                                ...
                                                return _this.resolvedDeferred.resolve(
                                                    _this
                                                );
                                            };
                                        })(this),
                                                    ...
                                                    .then(function() {
                                                        ...
                                                        containerPromise =
                                                            ...
                                                            null
                                                                ...
                                                                : $q.reject(
                                                                      "Missing containerTemplate or containerTemplateUrl"
                                                                  );
                                                        return containerPromise.then(
                                                            function(
                                                                ...
                                                                var containerElement,
                                                                    templatePromise;
                                                                containerElement = angular.element(
                                                                    containerTmpl.data
                                                                );
                                                                if (
                                                                    _this
                                                                ...
                                                                return templatePromise.then(
                                                                    function(
                                                                        ...
                                                                        angular
                                                                            .element(
                                                                                containerElement[0].querySelector(
                                                                                    ".popeye-modal"
                                                                                )
                                                                            )
                                                                            .append(
                                                                        ...
                                                                        _this.container = $compile(
                                                                            containerElement
                                                                        )(
                                                                            _this.scope
                                                                        );
                                                                        _this.element = angular.element(
                                                                            _this.container[0].querySelector(
                                                                                ".popeye-modal"
                                                                            )
                                                                        );
                                                                        if (
                                                                        ...
                                                                        return $animate
                                                                            ...
                                                                            .then(
                                                                                function() {
                                                                                    currentModal = _this;
                                                                                    return _this.openedDeferred.resolve(
                                                                                        _this
                                                                                    );
                                                                                }
                                                                            );
                            ...
                            PopeyeModal.prototype.handleError = function(
                                error
                            ) {
